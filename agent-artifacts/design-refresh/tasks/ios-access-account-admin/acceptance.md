...
- Setup/login actionable errors integrate with startup readiness rather than creating a second gate.
- Large Dynamic Type, keyboard, focus, native navigation/sheets/alerts, and honest no-op states remain usable.

## Boundary Proof

- Focused iOS tests cover state transitions, privacy/authorization, and readiness presentation.
