...
- Calendar models (CalendarEvent, Occurrence, RRULE subset, Visibility, Importance, Group, Tags, exceptions) mirroring the gateway domain and serving-tz representation
- Unit tests for the client golden-fixture wire shape and model mapping

## Required Work

- 1. Create shared/mobile-sdk calendar models mirroring the gateway domain (event, occurrence, rrule subset, visibility, importance, group, tags, exceptions) and serving-tz representation.
