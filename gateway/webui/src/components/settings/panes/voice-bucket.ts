// gateway/webui/src/components/settings/panes/voice-bucket.ts
//
// Pure helpers for the voice pane's faceted-search UX. The voice catalog
...
import type { VoiceEntry } from "../../../services/providers-api.ts";
...
export function deriveFilterOptions(voices: VoiceEntry[]): FilterOptions {
...
export function applyFilters(voices: VoiceEntry[], f: VoiceFilters): VoiceEntry[] {
...
export function sortVoices(voices: VoiceEntry[], sort: SortKey): VoiceEntry[] {
