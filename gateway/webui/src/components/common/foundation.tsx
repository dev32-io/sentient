...
export function ActionButton({ children, variant = "default", type = "button", disabled, loading, className, title, role, ariaLabel, buttonRef, expanded, hasPopup, onClick }: ActionButtonProps): JSX.Element {
  return (
    <button
