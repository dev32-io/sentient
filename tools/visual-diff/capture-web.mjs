...
const FIXED_CANVAS_COMPONENTS = new Set(["checkbox", "filter-bar", "inline-secret-editor", "loading-state", "media-action-card", "range", "search-field", "sentient-identity", "setting-row", "settings-editor", "settings-group", "text-area", "text-field", "toggle", "user-avatar", "validated-field"]);
