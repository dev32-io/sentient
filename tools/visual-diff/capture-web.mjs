...
const FIXED_CANVAS_COMPONENTS = new Set(["checkbox", "loading-state", "media-action-card", "range", "search-field", "sentient-identity", "text-area", "text-field", "toggle", "user-avatar", "validated-field"]);
