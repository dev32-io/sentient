...
export const WEB_FOUNDATION_TRANSITIONAL_ALLOWLIST: readonly TransitionalAllowlistEntry[] = [
  ...
  { path: "src/components/dock/dock-styles.tsx", reason: "chat composer product-composite presentation" },
  ...
  { path: "src/components/dock/tts-button.tsx", reason: "chat composer native controls" },
