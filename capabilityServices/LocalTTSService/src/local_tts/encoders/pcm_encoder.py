...
log = logging.getLogger("local_tts.encoders.pcm_encoder")

# Engine output rate — imported from ``audio_constants``
# (the single source of truth, MLX-free) rather than ``engine.py``
