...
Providers: STT via local STTService (Python service wrapping Silero VAD + Smart-Turn v3 + SenseVoice-Small); TTS via local-tts (LocalTTSService, Qwen3-TTS multilingual, native on-host Metal/MLX, dialed over WS); LLM via Hermes worker.
