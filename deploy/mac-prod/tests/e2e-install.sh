...
# to the installer.
#
#   bash deploy/mac-prod/tests/e2e-install.sh <workdir> [port]
#
# REAL here:
...
#   and a real HTTPS endpoint verified against a real pinned CA — no
...
WORK="${1:?usage: e2e-install.sh <workdir> [port]}"
PORT="${2:-18901}"
