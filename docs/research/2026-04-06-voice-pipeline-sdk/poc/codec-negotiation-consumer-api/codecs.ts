// ── Built-in codecs — developer never touches these directly ──
...
export class OpusCodec implements AudioCodec {
  ...
  encode(_samples: Float32Array): Uint8Array {
    // Real impl would use WebCodecs AudioEncoder or WASM libopus
...
/** Registry — SDK resolves codec by encoding name */
