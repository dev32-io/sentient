...
// (design §5.4 / §7). Closest analog: TaskListConnector's rows — but that one is
// a full-state mirror of an ephemeral strip, whereas a delegation row is
// agent-scoped and outlives the turn that dispatched it —
