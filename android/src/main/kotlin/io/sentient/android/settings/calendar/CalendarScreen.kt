...
object CalendarTestTags {
    ...
    const val FRESHNESS_UP_TO_DATE = "calendar-freshness-up-to-date"
    const val FRESHNESS_REFRESHING = "calendar-freshness-refreshing"
    const val FRESHNESS_STALE = "calendar-freshness-stale"
    const val FRESHNESS_OFFLINE = "calendar-freshness-offline"
    const val FRESHNESS_UNAVAILABLE = "calendar-freshness-unavailable"
